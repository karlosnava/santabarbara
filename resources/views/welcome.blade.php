    ...
    <div class="col-span-10 md:col-span-7 bg-white rounded-md border shadow-md p-4">
      <div x-data="{ sedea: false, sedeb: false, sedec: false, todas: true }">
        <div class="grid grid-cols-4 gap-1 md:gap-3">
          <div x-on:click="sedeb = false, sedec = false, sedea = false, todas = true" :class="todas ? 'text-sky-600 bg-sky-200 hover:bg-sky-200' : 'text-gray-600 hover:bg-gray-200'" class="cursor-pointer font-bold text-center rounded-md py-4">Todas</div>
